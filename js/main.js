...
$(document).ready(function () {
  ...
  $("#submitBtn").on("click", function () {
    ...
    const correct = questionsData[currentQuestionIndex].answer;
    const score = selected === correct ? 5 : 0;
    userScores[currentQuestionIndex] = score;

    // 모든 문제에 대한 점수가 userScores에 채워져 있으므로 총점 계산
